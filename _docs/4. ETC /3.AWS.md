...
**Foreground Process**
<div class="content-box">
 A process that requires user input and is executed in the foreground. The shell waits for the process to complete before accepting new input from the user.
</div>

**Background Process**
<div class="content-box">
 A process that executes independently of user input. The shell does not wait for the process to complete and the user can continue to issue commands while the process runs in the background.
 </div>
